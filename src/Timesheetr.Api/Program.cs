...
builder.Services.AddHttpClient<TogglService>(c =>
    c.BaseAddress = new Uri(builder.Configuration["ExternalServices:TogglBaseUrl"]!));
builder.Services.AddHttpClient<TempoService>(c =>
    c.BaseAddress = new Uri(builder.Configuration["ExternalServices:TempoBaseUrl"]!));
